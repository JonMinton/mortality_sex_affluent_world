...
png(
  "figures/original_extended/figure1_sex_ratio.png",
  res=300,
...
png(
  "figures/original_extended/figure2_smoothed_first_derivative.png",
  res=300,
  height=20, width=20, units="cm"
)
print(p)
...
ggsave(filename ="figures/original_extended//figure3_mortper1000peryear.png",
